...
# vscode
zstyle ':omz:plugins:vscode' aliases no
...
plugins=(ssh-agent gitfast zsh-syntax-highlighting zsh-navigation-tools docker command-not-found vscode zsh-autosuggestions)
